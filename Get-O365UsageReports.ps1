...
param(
    ...
    [string]$AzureAppClientId = "bd8a0fa3-4e55-4929-8b80-c5de381fd3a1",  #Azure Application Client ID with Microsoft Graph - Read all usage reports permissions, Manage-AzureAppRegistration: http://realtimeuc.com/2017/12/manage-azureappregistration
    [Parameter(Mandatory=$true)]
    [Pscredential]$Credential =  $cred,  #$(Get-Credential),
